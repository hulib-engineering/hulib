...
process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME = process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME ?? 'mock';
process.env.NEXT_PUBLIC_UPLOAD_PRESET = process.env.NEXT_PUBLIC_UPLOAD_PRESET ?? 'mock';
