...
export const DAY_KEY_TO_JS_WEEKDAY = [1, 2, 3, 4, 5, 6, 0] as const;

export const FILTER_OPTIONS: FilterKey[] = ['all', 'invitation', 'my_request', 'done', 'missed'];

export const TIMESLOTS_BY_PERIOD = {
