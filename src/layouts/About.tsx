...
const About = () => {
  ...
  return (
    <section className="mt-8 px-4 py-3 sm:px-0 lg:py-[6.25rem]">
      <div className="mx-auto mb-6 text-center sm:w-3/4 lg:mb-[5.625rem]">
      ...
      <div className="flex flex-col gap-6 lg:gap-[6.25rem] lg:px-12 2xl:px-[5.625rem]">
