...
const Footer = () => {
  ...
  return (
    <footer className="flex w-full items-center justify-center self-stretch p-[5.625rem]">
      <div className="flex w-[78.75rem] flex-col items-start justify-center gap-8">
