...
export const poppins = localFont({
  src: [
    { path: './fonts/SVN-Poppins-Light.otf', weight: '300', style: 'normal' },
    { path: './fonts/SVN-Poppins-Medium.otf', weight: '400', style: 'normal' },
    { path: './fonts/SVN-Poppins-MediumItalic.otf', weight: '400', style: 'italic' },
    { path: './fonts/SVN-Poppins-Bold.otf', weight: '700', style: 'normal' },
    { path: './fonts/SVN-Poppins-ExtraBold.otf', weight: '800', style: 'normal' },
    { path: './fonts/SVN-Poppins-Black.otf', weight: '900', style: 'normal' },
  ],
  display: 'swap',
});
