    ...
    return (
      <label
        ...
        className={mergeClassnames(
          ...
          'hover:bg-neutral-90 hover:border hover:border-neutral-90',
      ...
      >
        ...
        <span
          className={mergeClassnames(
            'absolute inset-0 flex items-center justify-center p-1 transition-colors text-xl peer-checked:shadow-none',
            'peer-focus:shadow-[0_0_0_2px_#0858FA] peer-focus:p-1 peer-focus:rounded-full',
