...
const FAQs = (): JSX.Element => {
  return (
    // TODO remove bg
    <section className="flex flex-col items-center justify-center gap-8 self-stretch py-[5.625rem] text-[#002254]">
      <div className="flex w-[48rem] flex-col items-center justify-center gap-8">
