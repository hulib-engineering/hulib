...
export default function RegisterHuberSuccess() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <BackButton text={t('success_back')} />
      ...
      <div className="flex flex-col items-center px-[96px] pb-16 pt-10">
        ...
        <div className="flex gap-4">
          <button type="button" onClick={() => router.push(`/users/${story.humanBookId}?tab=about`)} className="hover:bg-gray-50 h-[44px] w-[232px] rounded-full border border-[#C2C6CF] px-6 py-3 text-sm font-medium text-[#0442BF] transition-colors">
            {t('back_to_profile')}
          </button>
          <button type="button" onClick={() => router.push(`/`)} className="flex h-[44px] w-[232px] items-center justify-center gap-2 rounded-full bg-gradient-to-b from-[#007CBE] to-[#8845C6] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#14144a]">
            <Image
